  ...
  <div class="sm:ml-64 text-xl text-gray-300">
    <div class="mx-auto 2xl:w-6/12 p-4 mt-12">
      ...
      <p>
        ...
        website eruit zal komen te zien. Ik maak hier een klikbaar wireframe
      ...
      />
      <p class="italic text-sm">
        Figure 4: Figma clickable wireframe voor testing
      </p>
      <p class="mt-4">
        ...
        zorgen we er samen voor om een website te maken die niet alleen voldoet
        aan de wensen van de klant, maar er ook professioneel uit ziet.
      </p>
      ...
      <p class="mt-4">
        In de toekomst wil ik mijn klant relaties verder versterken door nog
        efficiënter te werken en klanten beter te betrekken tijdens het proces.
        Zo denk ik er aan om nieuwe tools te gebruiken. Ook wil ik blijven
        werken aan mijn comminucatie met de klant. Door dit continu te
        verbeteren, hoop ik een nog sterkere reputatie op te bouwen en ons
